var e = require("../../BAA9D332B878E4CFDCCFBB35F9386783.js"), t = require("../../B5ACACA2B878E4CFD3CAC4A5D2D86783.js");
...
(0, e.VantComponent)({
    ...
    methods: {
        ...
        setColumnValues: function(e, t) {
            ...
            return null == s ? Promise.reject(new Error("setColumnValues: 对应列不存在")) : JSON.stringify(s.data.options) === JSON.stringify(t) ? Promise.resolve() : s.setData({
                options: t
            }, function() {
                n && s.setIndex(0);
            });
