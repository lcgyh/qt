var e = require("../../@babel/runtime/helpers/interopRequireDefault"), o = require("../../C4DDA123B878E4CFA2BBC924B8096783.js"), t = e(require("../../481D43C1B878E4CF2E7B2BC653496783.js")), a = require("../../AD0111C0B878E4CFCB6779C705596783.js"), n = require("../../167BC423B878E4CF701DAC2479196783.js"), s = require("../../18B8A9E0B878E4CF7EDEC1E7E0186783.js"), i = require("../../B20FF1E6B878E4CFD46999E127296783.js"), r = getApp();
...
Page({
    ...
    onLoad: function(e) {
        var o = this;
        if ((0, s.$Loading)(), e.oldUserId && wx.setStorageSync("oldUserId", e.oldUserId ? e.oldUserId : ""), 
        e.scene) {
            var a = decodeURIComponent(e.scene), n = a.split("_");
            if (console.log(a), n.length > 1) s.$Loading.hide(), wx.showModal({
                title: "接受邀请失败",
                ...
                cancelText: "重新邀请",
                success: function(e) {
                    e.confirm ? ((0, s.$Loading)(), o.inType("none")) : e.cancel && (0, s.$Toast)({
    ...
    inType: function(e, o) {
        ...
        "share" === e ? a ? 0 == n && this.getPop() : o ? (0, i.pickStore)({
            spShopId: o
        }, function(e) {
            wx.setStorageSync("spShopId", o), t.getPop();
        }) : s ? 0 == n && this.getPop() : wx.navigateTo({
    ...
    sameErrorCallback: function(e, o) {
        var t = this;
        s.$Loading.hide(), wx.stopPullDownRefresh(), 500 == e ? o.data.errorCode && o.data.errorMsg ? wx.showModal({
        ...
        (0, n.homeContent)(function(o) {
            ...
            e.setData({
              ...
              console.log('tab', t.flowProduct)
                s.$Loading.hide(), wx.stopPullDownRefresh(), t.flowProduct.length > 0 && e.getHomeGoods(0);
            });
        }, e.sameErrorCallback);
    },
    getHomeGoods: function(e) {
        ...
        (0, n.homeGoods)(r, function(t) {
          ...
          console.log('tabList',i)
            ...
            s.$Loading.hide(), wx.stopPullDownRefresh(), (0, s.$Toast)({
                content: "小Q走丢了",
                duration: 1.5
            });
        });
    ...
    tabChange: function(e) {
        ...
        a.length <= 0 || n && n.length > 0 || ((0, s.$Loading)(), this.getHomeGoods(o));
    },
    ...
    getNewUserCoupon: function() {
        var e = this;
        wx.getStorageSync("userMobile") ? ((0, s.$Loading)(), (0, n.newUserCoupon)(function(o) {
            s.$Loading.hide();
            ...
            s.$Loading.hide(), 500 == e || "E_500" == e ? o.data.message ? wx.showModal({
                content: o.data.message,
                confirmColor: "#464646",
                cancelColor: "#969696",
                confirmText: "确定",
        ...
        wx.scanCode({
            ...
            success: function(e) {
                if ("scanCode:ok" === e.errMsg) if (console.log(e), e.result) {
                    ...
                    (0, s.$Loading)(), (0, o.getGoodsDetailBySearch)(t, function(o) {
                        s.$Loading.hide();
