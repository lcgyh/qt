...
Page({
    ...
    selectAll: function(t) {
        var n = this, r = t.currentTarget.dataset.type, e = t.currentTarget.dataset.check, i = this.data.scrollTop, c = {
            type: r,
            checkStatus: -1
        };
        c.checkStatus = 1 == e ? 0 : 1, (0, a.$Loading)(), (0, o.cartCheckAllGood)(c, function(t) {
            n.getCartList("selectall", i);
        }, function() {
